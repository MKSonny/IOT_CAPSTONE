...
def parse_opt():
    ...
    parser.add_argument('--poseweights', nargs='+', type=str, default='C:\\Users\\ICT\\Desktop\\youda\\IoT_Capstone\\DeepLearning\\yolov7\\yolov7_w6_pose.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='C:/Users/ICT/Desktop/youda/data/nonviolence/33.mp4', help='video/0 for webcam') #video source
    parser.add_argument('--device', type=str, default='cuda', help='cpu/0,1,2,3(gpu)')   #device arugments
