            ...
            # elif detection == 'false' and is_record == True: # 녹화중인 상태에서 다시 녹화버튼을 누르면
                ...
                if platform == 'android':
                     message = messaging.Message(
                        ...
                        token = 'f85XmM4wTNiOeX3em7pURj:APA91bGobKtCt51TG5o_F-b2dZvNFVv4qnU3jjykYh7t5BDc7OjQuyyGA59wMe11vLiA_3T3E2paDSQe6Yo16DpUGUrdcwRLdpxN0pUCWsiYRC3Zp0ehlsoAZQLGKOWwWE5i2NuZ9yLF'
                        )
